              ...
              <div className="agentprop-tabcontent">
                {deals && (
                  <>
                    ...
                    <Row className="agentprop-tableinside">
                      <h1>
                        {" "}
                        Packages for 2 adults from 30th June 2022 to 03rd July
                        2022
                      </h1>
                ...
                {photos && (
                  <>
                    <Slider {...settings} className="agent-prop-pic">
                      {!loading &&
                        !error &&
                        prop[0].images.length !== 0 &&
                        prop[0].images.map((img) => (
                          <div>
                ...
                {deatails && (
                  <div>
                    ...
                    {!loading &&
                      !error &&
                      prop[0].rooms.length !== 0 &&
                      prop[0].rooms.map((room) => (
